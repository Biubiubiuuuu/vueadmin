    ...
    <div class="dashboard-container">
      <div class="dashboard-container" style="background-color: #FFFFFF;padding: 0px 15px 10px 15px;">
        <el-tabs v-model="CollectionAccountTabs">
          <el-tab-pane label="账户流水" name="CollectionAccountTab">
            <el-table
              v-loading="loading"
              :data="tableData"
            ...
            >
              ...
              <el-table-column label="时间" prop="bankName" align="center" />
              <el-table-column label="支付方式" prop="realName" align="center" />
              <el-table-column label="充值/核销金额" prop="account" align="center" min-width="120px" sortable />
              <el-table-column label="账户余额" prop="account" align="center" show-overflow-tooltip />
              <el-table-column label="备注" prop="account" align="center" show-overflow-tooltip />
            </el-table>
          </el-tab-pane>
        </el-tabs>
